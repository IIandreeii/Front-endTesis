...
export default function Profile() {
  ...
  const handleViewProductDonations = () => {
            ...
            {type === 'charity' && (
              <>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="flex flex-col gap-2"> handleViewaudits
                    <Button className="text-[#4c7d78]" onClick={handleViewDonations}>Ver Donaciones</Button>
                    <Button className="text-[#4c7d78]" onClick={handleViewProductDonations}>Ver Donaciones de Productos</Button>
                    <Button className="text-[#4c7d78]" onClick={handleViewaudits}>Ver Donaciones de Productos</Button>
                  </div>
                </div>
              </>
            )}
