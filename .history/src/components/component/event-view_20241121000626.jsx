...
const EventViewComponent = () => {
    ...
    const handleDeleteClick = async (publicationId) => {
        ...
        socket.emit('deletePublication', { publicationId, charityId: user._id }, (response) => {
            console.log
            if (response.success) {
    ...
    return (
        <div className="min-h-full p-4 bg-gradient-to-br from-[#D8C7A9] to-[#ECE3D4]">
            ...
            <div className="flex justify-end mb-4">
                <Button onClick={() => router.push('/posteo')} className="bg-[#042637] hover:bg-[#042637]/90 text-white flex items-center">
                    <Plus className="mr-2" />
                    Crear Publicación
                </Button>
            </div>
