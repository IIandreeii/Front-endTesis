...
export default function Organizaciones() {
  ...
  useEffect(() => {
    const fetchCharities = async () => {
      try {
        const res = await fetch('https://rwggxws5-3001.brs.devtunnels.ms/charities', {
          method: 'GET',
          headers: {
    ...
    if (!isLoggedIn) {
      ...
      try {
        const body = JSON.stringify({
          ...
          userType: user.userType, // Usar userType del perfil del usuario
        ...
        const res = await fetch('https://rwggxws5-3001.brs.devtunnels.ms/chats', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json'
          },
