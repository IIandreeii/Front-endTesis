  ...
  return (
    <div className="flex h-screen bg-[#ECE3D4]">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center p-4 bg-[#D8C7A9]">
          <input
            type="text"
            value={message}
            onChange={(e) => setMessage(e.target.value)}
            placeholder="Escribe un mensaje..."
            className="w-full bg-[#E1DDBF] p-3 rounded-full text-[#042637] placeholder-[#042637]/50 focus:outline-none"
          />
          <button onClick={handleSend} className="text-[#042637] hover:bg-[#E1DDBF] p-3 rounded-full ml-2">
            <Send size={20} />
          </button>
        </div>
      </div>
